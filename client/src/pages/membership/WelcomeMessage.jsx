  ...
  return (
    <div className="flex flex-col  ">
      ...
      <div className="flex-row mt-20">
        <button className="px-4 py-2 rounded-3xl  font-bold bg-pred-100  text-pred-600  hover:bg-red-600  ">Back to home</button>
        <button className="px-4 py-2 rounded-3xl  font-bold ml-5 bg-pred-500 text-white  hover:bg-gray-400 ">Check Membership</button>
      </div>
    </div>
  );
}
