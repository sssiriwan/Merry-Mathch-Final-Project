      ...
      <section className="h-[900px] flex">
        ...
        <section className="w-[70%] bg-putility-400 flex justify-center items-center">
          <div className="relative">
            <div className="flex absolute font-bold text-3xl bottom-10 left-6 text-white">
            <h1>Daeny</h1>
            <h2 className="ml-2 text-pgray-400">24</h2>
            </div>
            <img
              className="w-[500px] h-[500px] rounded-3xl object-cover"
              src="https://media.discordapp.net/attachments/1120567478632861736/1147928137716465767/IMG_9424.jpg?width=373&height=497"
            />
          </div>
        </section>
      </section>
